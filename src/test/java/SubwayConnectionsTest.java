...
//        // when
//        Map<String, List<String>> connectionsMap = subwayConnections.mapConnections();
//        List<String> directConnections = subwayConnections.getDirectConnections("65");
//        List<String> resultConnections = Arrays.asList("35", "64", "66", "75", "139");
//
//        // then
//        Assert.assertNotNull(directConnections);
//        Assert.assertEquals(directConnections, resultConnections);
//
//    }
